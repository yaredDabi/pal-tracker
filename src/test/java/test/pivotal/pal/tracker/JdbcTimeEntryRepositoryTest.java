...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() throws Exception {
        TimeEntry newTimeEntry = new TimeEntry(123, 321, LocalDate.parse("2017-01-10"), 8);
    ...
    public void updateReturnsTheUpdatedRecord() throws Exception {
        ...
        TimeEntry timeEntryUpdates = new TimeEntry(456, 987, LocalDate.parse("2017-01-09"), 10);
        ...
        assertThat(updatedTimeEntry.getDate()).isEqualTo(LocalDate.parse("2017-01-09"));
